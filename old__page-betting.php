<?php
/*
 * Template Name: OLD Betting Page
 */
            ...
            <div class="row">
              ...
              <div class="col-md-12 bet-fights">
                <?php foreach ($fights_order as $fight) { ?>
                  ...
                  <table>
                    <tr>
                      <td colspan="3" class="bet-fight-title">
                        <?php echo $fight->weight_class ?>
                      </td>
                    </tr>
                    <tr>
                      <td width="40%" class="bet-img">
                    ...
                    <tr class="fight">
                      <td width="40%" class="fight-<?php echo $fight->id ?> bet-fighter fighter-1<?php if ($betValue === 'fighter1'){echo ' bet-fighter-selected';}?>" id="<?php echo $fight->id ?>-fighter1">
                        <?php echo $fight->fighter1; ?>
                      </td>
                      <td width="20%" class="bet-fighter-td">
                        vs
                      </td>
                      <td width="40%" class="fight-<?php echo $fight->id ?> bet-fighter fighter-2<?php if ($betValue === 'fighter2'){echo ' bet-fighter-selected';}?>" id="<?php echo $fight->id ?>-fighter2">
